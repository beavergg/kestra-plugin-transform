...
public class HackathonLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "EQ", "NE", "GT", "LT", "STRING", "INT", "DOUBLE", "PUT", "REMOVE", 
			"RENAME", "GETFIELD", "CONCAT", "INDEX", "LEN", "LASTINDEXOF", "SUBSTRING", 
			"DOUBLEPARSE", "DATEFORMAT", "LOOKUP", "NOOP", "FILTER", "IF", "COMMENTS", 
			"NEWLINE", "SEMICOLON", "LB", "RB", "COMMA", "WS"
		};
	}
	...
	public HackathonLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "Hackathon.g4"; }
